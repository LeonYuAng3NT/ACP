...
INSERT INTO Product (pID, name,root, parent,dateIssued,imageURL, artist,description, admin) VALUES ('P12345','Anime','P12345','P12345','now','https://s3.amazonaws.com/ACPimages/dummyb1p2.jpeg','Leon','This is a picture of Doraemon', 1);
INSERT INTO Product (pID, name,root, parent,dateIssued,imageURL, artist,description, admin) VALUES ('P11111','Anime','P11111','P11111','now','https://s3.amazonaws.com/ACPimages/dummyb1p2.jpeg','YuAng','Doraemon all the way', 1);
...
INSERT INTO Product (pID, name,root, parent,dateIssued,imageURL, description,admin,artist) VALUES ('pp1', 'hand1', 'pp1', 'pp1', 'now', 'https://s3.amazonaws.com/ACPimages/dummyb1p1.jpeg', 'Holding hands, so that we can make our world better','Admin333', 'leonzhang1996@126.com');
